  ...
  return (
    <>
      <div className="h-svh overflow-hidden grid place-items-center">
        <div className="border relative overflow-hidden bg-gray-900 md:pt-0 shadow-2xl sm:rounded-3xl md:px-16 pt-12 md:flex lg:gap-x-20 lg:px-24 h-3/4 w-[90%] md:w-3/4 rounded-lg">
